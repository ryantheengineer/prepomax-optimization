...
def objective_fun(modulus, poisson, preload_pmx_file, disp_pmx_file, results_directory, ccx_executable, number_of_cores):
    ...
    calculix_runner_preload = CalculiXRunner(results_directory,
                                             ccx_executable,
                                             pmx_file=None,
                                             geo_source_file=None,
                                             geo_target_file=None,
